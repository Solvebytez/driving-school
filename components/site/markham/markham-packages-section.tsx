...
const markhamPackages = [
  {
    id: 1,
    name: "Markham Basic Package",
    price: "$49.99",
    description: "Perfect for beginners in Markham area",
    features: [
      ...
      "Free Pick up & Drop off in Markham",
  ...
  {
    id: 2,
    name: "Markham Ultra Package",
    price: "$124.99",
    description: "Most popular choice for Markham students",
    features: [
      "11 Hours Of In-Car Training (1-On-1)",
      "20 Hours of In-Class-Training or Online",
      "10 Hours of Homelinks",
      "Certification With The Ministry of Transportation",
      "Use of an Instructor's car for Markham G2 Road Test",
  ...
  {
    id: 3,
    name: "Markham Premium Package",
    price: "$89.99",
    description: "Comprehensive training for Markham drivers",
    features: [
...
export function MarkhamPackagesSection() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 text-center">
          <h2 className="pathway-extreme text-3xl font-bold text-charcoal md:text-4xl lg:text-5xl">
            Markham Driving Packages & Offers
          </h2>
          <p className="onest text-gray-600 mt-4 max-w-2xl mx-auto">
            Choose the perfect driving package for your needs in Markham. All

...
const richmondHillPackages = [
  {
    id: 1,
    name: "Richmond Hill Basic Package",
    price: "$49.99",
    description: "Perfect for beginners in Richmond Hill area",
    features: [
      ...
      "Free Pick up & Drop off in Richmond Hill",
  ...
  {
    id: 2,
    name: "Richmond Hill Ultra Package",
    price: "$124.99",
    description: "Most popular choice for Richmond Hill students",
    features: [
      "11 Hours Of In-Car Training (1-On-1)",
      "20 Hours of In-Class-Training or Online",
      "10 Hours of Homelinks",
      "Certification With The Ministry of Transportation",
      "Use of an Instructor's car for Richmond Hill G2 Road Test",
  ...
  {
    id: 3,
    name: "Richmond Hill Premium Package",
    price: "$89.99",
    description: "Comprehensive training for Richmond Hill drivers",
    features: [
...
export function RichmondHillPackagesSection() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 text-center">
          <h2 className="pathway-extreme text-3xl font-bold text-charcoal md:text-4xl lg:text-5xl">
            Richmond Hill Driving Packages & Offers
          </h2>
          <p className="onest text-gray-600 mt-4 max-w-2xl mx-auto">
            Choose the perfect driving package for your needs in Richmond Hill.

...
export const locations: Record<string, LocationData> = {
  bradford: {
    ...
    phone: "(905)-392-1472",
    email: "bradford@drivinghero.com",
  ...
  newmarket: {
    ...
    phone: "(905)-392-1472",
    email: "newmarket@drivinghero.com",
    hours: "Mon to Sat: 8:00 am - 7:00 pm",
    mapEmbed:
  ...
  "richmond-hill": {
    ...
    phone: "(905)-392-1472",
    email: "richmondhill@drivinghero.com",
    hours: "Mon to Sat: 8:00 am - 7:00 pm",
    mapEmbed:
  ...
  scarborough: {
    ...
    phone: "(905)-392-1472",
    email: "scarborough@drivinghero.com",
    hours: "Mon to Sat: 8:00 am - 7:00 pm",
    mapEmbed:
